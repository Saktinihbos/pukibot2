...
if (!m.fromMe && m.text.match(/(Wkwk|Awok|Ngen|ngentod)/gi)) {
        conn.updatePresence(m.chat, Presence.recording)
        conn.sendFile(m.chat, 'src/gligik.opus', 'tts.opus', null, m, true)
    	}
if (!m.fromMe && m.text.match(/(Hai)/gi)) {
        conn.updatePresence(m.chat, Presence.recording)
        conn.sendFile(m.chat, 'src/oasu.opus', 'tts.opus', null, m, true)
    	}
if (!m.fromMe && m.text.match(/(Bot|bot|Iya|Haha)/gi)) {
        conn.updatePresence(m.chat, Presence.recording)
        conn.sendFile(m.chat, 'src/oasu.opus', 'tts.opus', null, m, true)
    	}
