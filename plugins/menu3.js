...
`.trim()
 ...
 await conn.send2ButtonImg(m.chat, text.trim(), `./src/logo.jpg`, "© yo bot", 'Menu', '.hah', 'Owner', '.owner', { quoted: freply, sendEphemeral: true, contextInfo: { mentionedJid: conn.parseMention(text), forwardingScore: 135, isForwarded: true }})
}
